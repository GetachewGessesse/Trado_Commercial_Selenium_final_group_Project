...
import allure
import pytest
from Web.Page.sales_page import Sales_page
...
class Test_snack():
    ...
    def test_sales_page(self):
        ...
        assertion_text = sales.sales_assertion
        assert "מבצעים" == assertion_text

    @allure.description('Test if the banner image clicks next button')
    @allure.severity(allure.severity_level.NORMAL)
    @pytest.mark.regression
    def test_banner_next(self):
        banner = Sales_page(self)
        banner.open_trado()
        banner.click_option1()
        banner.click_option2()
        banner.click_save_button()
        banner.click_on_sale_page()
        banner.click_on_next_picture()


    @allure.description('Test if the banner image clicks preview button')
    @allure.severity(allure.severity_level.NORMAL)
    @pytest.mark.regression
    def test_banner_preview(self):
        ...
        banner.click_save_button()
        banner.click_on_sale_page()
        banner.click_on_preview_picture()
    ...
    def test_displayed_as_list(self):
        lists = Sales_page(self)
        lists.open_trado()
        lists.click_option1()
        lists.click_option2()
        lists.click_save_button()
        lists.click_on_sale_page()
    ...
    def test_product(self):
        product = Sales_page(self)
        product.open_trado()
        product.click_option1()
        product.click_option2()
        product.click_save_button()
        product.click_on_sale_page()
        product.click_on_product_ogkush()
        assertion_text = product.sales_assertion
        assert "OG Kush" == assertion_text
    ...
    def test_product_add(self):
        ...
        product.click_on_sale_page()
        product.click_on_product_ogkush()
        product.click_on_product_ogkush_plus()
        assertion_text = product.add_product_assertion
        assert "₪27.96" == assertion_text
    ...
    def test_product_minus(self):
        ...
        product.click_on_sale_page()
        product.click_on_product_ogkush()
        product.click_on_product_ogkush_minus()
